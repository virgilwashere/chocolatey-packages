...
[![](https://ci.appveyor.com/api/projects/status/github/virgilwashere/chocolatey-packages?svg=true)](https://ci.appveyor.com/project/virgilwashere/chocolatey-packages)
[Update status](https://gist.github.com/virgilwashere/ec91f45445829adbd537bfd15d82ccca)
[![](http://transparent-favicon.info/favicon.ico)](#)
[chocolatey/virgilwashere](https://chocolatey.org/profiles/virgilwashere)

This repository contains [chocolatey automatic packages](https://chocolatey.org/docs/automatic-packages).
The repository is setup so that I can manage the packages entirely from the GitHub web interface (using AppVeyor to update and push packages) and/or using my local repository copy.
...
- Powershell 5+.
- [Chocolatey Automatic Package Updater Module](https://github.com/majkinetor/au): `Install-Module au` or `choco upgrade au`.
